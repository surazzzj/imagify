...
const Header = () => {
    ...
    return (
        <motion.div className='flex flex-col justify-center items-center text-center my-20 '
            ...
            viewport={{ once: true }}
        >
            <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-400'
            ...
            <motion.button onClick={onClickHandler} className='flex items-center gap-2 rounded-full sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 '
